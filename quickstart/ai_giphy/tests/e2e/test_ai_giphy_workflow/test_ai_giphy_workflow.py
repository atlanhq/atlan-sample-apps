...
class TestAIGiphyWorkflow(unittest.TestCase, BaseTest):
    ...
    def prepare_dir_paths(cls):
        ...
        Overrides base method to skip schema directory check since ai_giphy
        ...
        # (not used for ai_giphy since there's no data validation)
    ...
    def test_configuration_get(self):
        ...
        # Verify that response data contains the expected ai_input_string
        self.assertEqual(
            response_data["data"]["ai_input_string"],
            self.test_workflow_args["ai_input_string"],
        )

    # Override BaseTest methods that don't apply to ai_giphy - all skipped
    @pytest.mark.skip(reason="AI Giphy workflow doesn't have auth endpoint")
    def test_auth(self):
        """Skip - ai_giphy doesn't have authentication."""
        pass

    @pytest.mark.skip(reason="AI Giphy workflow doesn't have metadata endpoint")
    def test_metadata(self):
        """Skip - ai_giphy doesn't have metadata endpoint."""
        pass

    @pytest.mark.order(4)
    @pytest.mark.skip(reason="AI Giphy workflow doesn't have preflight check endpoint")
    def test_preflight_check(self):
        """Skip - ai_giphy doesn't have preflight check."""
        pass
    ...
    @pytest.mark.order(7)
    @pytest.mark.skip(reason="AI Giphy workflow doesn't extract data for validation")
    def test_data_validation(self):
        """Skip - ai_giphy doesn't extract data."""
        pass

    @pytest.mark.order(8)
    @pytest.mark.skip(reason="AI Giphy workflow doesn't have auth endpoint")
    def test_auth_negative_invalid_credentials(self):
        """Skip - ai_giphy doesn't have auth endpoint."""
        pass
    ...
    @pytest.mark.skip(reason="AI Giphy workflow doesn't require credentials/metadata")

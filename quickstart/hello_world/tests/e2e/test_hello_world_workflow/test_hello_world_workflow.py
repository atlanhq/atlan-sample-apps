...
class TestHelloWorldWorkflow(unittest.TestCase, BaseTest):
    ...
    def prepare_dir_paths(cls):
        ...
        Overrides base method to skip schema directory check since hello_world
        ...
        # (not used for hello_world since there's no data validation)
    ...
    def test_run_workflow(self):
        """
        Test running the hello world workflow
        """
        self.run_workflow()
    ...
    def test_auth(self):
        """Skip - hello_world doesn't have authentication."""
        pass

    @pytest.mark.skip(reason="Hello World workflow doesn't have metadata endpoint")
    def test_metadata(self):
        """Skip - hello_world doesn't have metadata endpoint."""
        pass
    ...
    @pytest.mark.order(7)
    @pytest.mark.skip(reason="Hello World workflow doesn't extract data for validation")
    def test_data_validation(self):
        """Skip - hello_world doesn't extract data."""
        pass

    @pytest.mark.order(8)
    @pytest.mark.skip(reason="Hello World workflow doesn't have auth endpoint")
    def test_auth_negative_invalid_credentials(self):
        """Skip - hello_world doesn't have auth endpoint."""
        pass

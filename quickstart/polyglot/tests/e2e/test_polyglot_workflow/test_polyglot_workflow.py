...
class TestPolyglotWorkflow(unittest.TestCase, BaseTest):
    """E2E test for Polyglot workflow."""

    extracted_output_base_path = (
        "./local/dapr/objectstore/artifacts/apps/polyglot/workflows"
    )
    ...
    @pytest.mark.order(2)
    def test_auth(self):
        """Skip auth test for polyglot app."""
        # Polyglot app doesn't have auth endpoint
        pass

    @pytest.mark.order(3)
    def test_metadata(self):
        """Skip metadata test for polyglot app."""
        # Polyglot app doesn't have metadata endpoint
        pass

    @pytest.mark.order(4)
    def test_preflight_check(self):
        """Skip preflight check test for polyglot app."""
        # Polyglot app doesn't have preflight check endpoint
        pass
    ...
    def test_data_validation(self):
        """Skip data validation test for polyglot app."""
        # Polyglot app doesn't perform data extraction/validation
        pass

...
class TestAccessibilityAuditWorkflow(unittest.TestCase, BaseTest):
    """E2E tests for Accessibility Audit workflow.

    This workflow:
    - Takes a URL as input
    - Runs accessibility checks using axe-core and optionally WAVE
    - Generates a combined accessibility report
    ...
    def prepare_dir_paths(cls):
        ...
        Overrides base method to skip schema directory check since accessibility_audit
        ...
        # (not used for accessibility_audit since there's no data validation)
    ...
    def test_run_workflow(self):
        """
        Test running the accessibility audit workflow
        """
        self.run_workflow()
    ...
    def test_configuration_get(self):
        ...
        # Verify that response data contains the expected URL
        self.assertEqual(response_data["data"]["url"], self.test_workflow_args["url"])

    # Override BaseTest methods that don't apply to accessibility_audit - all skipped
    @pytest.mark.skip(
        reason="Accessibility Audit workflow doesn't have auth endpoint"
    )
    def test_auth(self):
        """Skip - accessibility_audit doesn't have authentication."""
        pass

    @pytest.mark.skip(
        reason="Accessibility Audit workflow doesn't have metadata endpoint"
    )
    def test_metadata(self):
        """Skip - accessibility_audit doesn't have metadata endpoint."""
        pass

    @pytest.mark.order(4)
    @pytest.mark.skip(
        reason="Accessibility Audit workflow doesn't have preflight check endpoint"
    )
    def test_preflight_check(self):
        """Skip - accessibility_audit doesn't have preflight check."""
        pass

    @pytest.mark.order(6)
    @pytest.mark.skip(
        reason="Accessibility Audit workflow doesn't have metadata for configuration update"
    )
    def test_configuration_update(self):
        """Skip - accessibility_audit doesn't have metadata for updates."""
        pass

    @pytest.mark.order(7)
    @pytest.mark.skip(
        reason="Accessibility Audit workflow doesn't extract data for validation"
    )
    def test_data_validation(self):
        """Skip - accessibility_audit doesn't extract data."""
        pass
    ...
    def test_auth_negative_invalid_credentials(self):
        """Skip - accessibility_audit doesn't have auth endpoint."""
        pass
    ...
    @pytest.mark.skip(
        reason="Accessibility Audit workflow doesn't require credentials/metadata"
    )
    def test_run_workflow_with_invalid_credentials(self):
        """Skip - accessibility_audit doesn't require credentials."""
        pass

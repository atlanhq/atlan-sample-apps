...
class TestGenericWorkflow(unittest.TestCase, BaseTest):
    ...
    - Has configmap support (has_configmap=True)
    """
    ...
    def prepare_dir_paths(cls):
        ...
        Overrides base method to skip schema directory check since generic
        ...
        # (not used for generic since there's no data validation)
    ...
    def test_run_workflow(self):
        """
        Test running the generic workflow
        """
        self.run_workflow()
    ...
    def test_configuration_get(self):
        ...
        # Verify that response data contains the expected connection
        self.assertEqual(
            response_data["data"]["connection"], self.test_workflow_args["connection"]
        )

    # Override BaseTest methods that don't apply to generic - all skipped
    @pytest.mark.skip(reason="Generic workflow doesn't have auth endpoint")
    def test_auth(self):
        """Skip - generic doesn't have authentication."""
        pass

    @pytest.mark.skip(reason="Generic workflow doesn't have metadata endpoint")
    def test_metadata(self):
        """Skip - generic doesn't have metadata endpoint."""
        pass

    @pytest.mark.order(4)
    @pytest.mark.skip(reason="Generic workflow doesn't have preflight check endpoint")
    def test_preflight_check(self):
        """Skip - generic doesn't have preflight check."""
        pass
    ...
    @pytest.mark.order(7)
    @pytest.mark.skip(reason="Generic workflow doesn't extract data for validation")
    def test_data_validation(self):
        """Skip - generic doesn't extract data."""
        pass

    @pytest.mark.order(8)
    @pytest.mark.skip(reason="Generic workflow doesn't have auth endpoint")
    def test_auth_negative_invalid_credentials(self):
        """Skip - generic doesn't have auth endpoint."""
        pass
    ...
    @pytest.mark.skip(reason="Generic workflow doesn't require credentials/metadata")

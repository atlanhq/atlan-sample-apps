...
class TestGenericWorkflow(unittest.TestCase, BaseTest):
    """E2E test for Generic template workflow."""

    extracted_output_base_path = (
        "./local/dapr/objectstore/artifacts/apps/generic/workflows"
    )
    ...
    @pytest.mark.order(2)
    def test_auth(self):
        """Skip auth test for generic app."""
        # Generic app doesn't have auth endpoint
        pass

    @pytest.mark.order(3)
    def test_metadata(self):
        """Skip metadata test for generic app."""
        # Generic app doesn't have metadata endpoint
        pass

    @pytest.mark.order(4)
    def test_preflight_check(self):
        """Skip preflight check test for generic app."""
        # Generic app doesn't have preflight check endpoint
        pass
    ...
    def test_data_validation(self):
        """Skip data validation test for generic template app."""
        # Generic template app doesn't perform data extraction/validation
        pass

...
4. Run `atlan-fact-verification-gate` when output behavior changed or conflicts with existing tests.
5. Validate expected output sections in `e2e_case_contract.yaml`.
